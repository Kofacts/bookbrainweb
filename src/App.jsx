    ...
    <Router>
      ...
      <nav className="fixed top-0 left-0 w-full z-50 px-8 md:px-12 py-6 flex items-center justify-between bg-white/80 backdrop-blur-md border-b border-slate-100">
        ...
        <div className="flex items-center space-x-8">
          ...
          <a href="#personas" className="text-sm text-slate-500 hover:text-teal-600 transition-colors hidden md:block">How it Works</a>
          <a href="#testimonials" className="text-sm text-slate-500 hover:text-teal-600 transition-colors hidden md:block">Testimonials</a>
          <Link to="#pricing" className="text-sm text-slate-500 hover:text-teal-600 transition-colors">Pricing</Link>
