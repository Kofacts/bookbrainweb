    ...
    <div className="w-full min-h-screen bg-white text-slate-900 font-sans overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 px-8 md:px-12 py-6 flex items-center justify-between bg-white/80 backdrop-blur-md border-b border-slate-100">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a href="https://instagram.com/getbookbrain" className="text-sm text-slate-500 hover:text-teal-600 transition-colors">Instagram</a>
          <a href="https://twitter.com/getbookbrain" className="text-sm text-slate-500 hover:text-teal-600 transition-colors">Twitter</a>
        </div>
      </nav>
